  ...
  try {
    ...
    const catalog = [
      ...
      },
      {
        ...
        category: "NLP",
        tagline: "Zero-shot structured JSON extractor & legal logic synthesizer",
        bondAmountSol: 220,
        claimedAccuracy: 98.0,
        pricePerCallSol: 0.04,
        latencyMs: 510,
        strengths: ["Legal contract clause analysis", "JSON structured outputs", "Regulatory compliance checks"],
      },
      {
        ...
        latencyMs: 190,
        strengths: ["Raydium/Orca flash routing", "High-frequency signals", "Sub-200ms execution latency"],
      },
    ];
